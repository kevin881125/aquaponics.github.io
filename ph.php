...
<body>
    ...
    ?>
                ...
                <tr >															
						...
						<td style="border:1px solid #000;font-weight:400;" align="center" bgcolor=	#DDDDDD><font size= "5"><?php echo $row["1"];?></td></font>
						<?php
							if($row["1"] >= 7.5){
								echo '<td style="border:1px solid #000;font-weight:400;" align="center" bgcolor=	#FF0000><font size= "5">>7</td></font>';
                                $sum=$sum+1;
								}
							else if($row["1"] < 6.5){
								echo '<td style="border:1px solid #000;font-weight:400;" align="center" bgcolor=	#FF0000><font size= "5"><6.5</td></font>';
                                $sum=$sum+1;
							}else{
