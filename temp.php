...
<body>
    ...
    ?>
                ...
                <tr >															
						...
						<td style="border:1px solid #000;font-weight:400;" align="center" bgcolor=	#DDDDDD><font size= "5"><?php echo $row["5"];?></td></font>
						<?php
							if($row["5"] >= 41){
								...
								echo '<td style="border:1px solid #000;font-weight:400;" align="center" bgcolor=	#FF0000><font size= "5"><18</td></font>';
                                $sum=$sum+1;
							}else{
