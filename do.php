...
<body>
    ...
    ?>
                ...
                <tr >															
						...
						<td style="border:1px solid #000;font-weight:400;" align="center" bgcolor=	#DDDDDD><font size= "5"><?php echo ($row["3"])/1000+4;?></td></font>
						<?php
							if(($row["3"] /1000+4)>1000){
								echo '<td style="border:1px solid #000;font-weight:400;" align="center" bgcolor=	#FF0000><font size= "5">>1000</td></font>';
                                $sum=$sum+1;
								}
							else if(($row["3"] /1000+4)< 4){
